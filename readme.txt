...
Download link:	https://github.com/azurecurve/azrcrv-redirect/releases/download/v1.0.11/azrcrv-redirect.zip
...
Redirect URIs with a 301 (permanent) or 302 (temporary) redirect.
...
### [Version 1.0.11](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.11)
 * Fix bug with saving/display of destination URis including ascii codes for colons.

### [Version 1.0.10](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.10)
 * Update readme file for compatibility with ClassicPress Directory.
 * Fix bug with redirect count not being updated.

### [Version 1.0.9](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.9)
 * Update readme files.
 * Update language template.
 * Fix bug with azurecurve menu.
 
### [Version 1.0.8](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.8)
 * Fix bug with invalid table name.

### [Version 1.0.7](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.7)
 * Fix bug with prepare of query statement on manage redirect page.

### [Version 1.0.6](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.6)
 * Standardise prepare and query statements.
 ...
 * Improve sanitisation and escaping.

### [Version 1.0.2](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.2)
 * Fix issues with security (escaping and sanitizing).

### [Version 1.0.1](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.1)
 * Fix banner width.
 * Fix issues with security (escaping and sanitizing).
 * Fix issues with translation function calls.

### [Version 1.0.0](https://github.com/azurecurve/azrcrv-redirect/releases/v1.0.0)
 * Initial release.
